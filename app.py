...
def dialogflow_webhook():
    ...
    try:
        ...
        disease = (
            disease_param[0] if isinstance(disease_param, list) and disease_param else disease_param
        )
...
def sms_reply():
    ...
    try:
        ...
        # If no disease detected, reply immediately
        if not detected_disease:
            resp = MessagingResponse()
            resp.message("Please specify the disease name so I can help you.")
